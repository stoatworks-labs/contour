...
Nothing else can. `cntest` drives the real plugin class through a real FFGL
...
Nothing here checks the *ported* half. The blur weights, the sea's audio drive, the Clock and every conversion in
plugin.js are a hand translation of Contour.cpp, Audio.cpp, Clock.cpp and
Controls.cpp, and only a reader can tell
