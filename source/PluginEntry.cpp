/**
	...
	`CFFGLPluginInfo` that Contour.cpp registers at static-initialisation time.
	...
	binary: which build it is.
		...
		strings Contour.bundle/Contents/MacOS/Contour | grep contour
*/

extern "C" const char* ContourBuildStamp()
{
	return "contour " CONTOUR_VERSION " built " __DATE__ " " __TIME__;
}
